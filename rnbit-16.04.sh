#!/bin/bash
# RainBitCoin Masternode Setup Script V1.0 for Ubuntu 16.04 LTS
#
...
wget https://github.com/raininfotech/RainBitCoin/releases/download/v1.0/RainBit-daemon-ubuntu-16.04.tar.gz
tar -xzvf RainBit-daemon-ubuntu-16.04.tar.gz
